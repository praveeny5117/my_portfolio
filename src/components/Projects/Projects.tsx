...
import { ExternalLink, BookOpen, Building2, Sparkles, Layers, Briefcase, Image as ImageIcon } from 'lucide-react';
...
export const Projects: React.FC = () => {
  ...
  const [initialCaseStudyTab, setInitialCaseStudyTab] = useState<'overview' | 'gallery' | 'architecture' | 'features' | 'results'>('overview');
  ...
  return (
    <>
                    ...
                    >
                      <div 
                        onClick={() => {
                          ...
                          setInitialCaseStudyTab('overview');
                        }}
                        className="cursor-pointer transition-transform duration-400 ease-out hover:scale-[1.01] overflow-hidden rounded-2xl"
                      >
                        <ProjectVisualMockup
                          ...
                          onOpenGallery={() => {
                            setActiveCaseStudy(project);
                            setInitialCaseStudyTab('gallery');
                          }}
                        />
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div className="space-y-2.5">
                        <div className="flex flex-wrap items-center gap-3">
                          ...
                          {/* Real UI Screenshots Indicator Badge */}
                          {project.screenshots && project.screenshots.length > 0 && (
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-mono font-semibold bg-[#00F0FF]/10 hover:bg-[#00F0FF]/25 text-[#00F0FF] border border-[#00F0FF]/30 transition-all cursor-pointer shadow-sm"
                              title="Click to view live UI screenshots in gallery"
                            >
                              <ImageIcon className="w-3 h-3" />
                              <span>{project.screenshots.length} Real Screens</span>
                            </button>
                          )}
                      ...
                      <div className="flex flex-wrap items-center gap-3 pt-2">
                        ...
                        {/* Direct UI Gallery Button for Projects with Screenshots */}
                        {project.screenshots && project.screenshots.length > 0 && (
                          <button
                            type="button"
                            onClick={() => {
                            ...
                            className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-[#00F0FF]/10 hover:bg-[#00F0FF]/20 text-[#00F0FF] border border-[#00F0FF]/30 font-semibold text-xs font-mono transition-all duration-200 hover:-translate-y-0.5 shadow-sm"
                            title="Open full interactive UI screenshots gallery"
                          >
                            <ImageIcon className="w-3.5 h-3.5" />
                            <span>UI Gallery ({project.screenshots.length})</span>
                          </button>
                        )}
      ...
      <CaseStudyModal
        ...
        initialTab={initialCaseStudyTab}
      />
    </>
  );
};
